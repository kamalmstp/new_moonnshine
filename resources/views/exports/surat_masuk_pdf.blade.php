...
<html>
<head>
    <title>Laporan Data Surat Masuk SMAN 2 Banjarmasin</title>
    ...
    <style>
        ...
        /* Styling Tabel Data Surat Masuk */
        table {
            width: 100%;
            border-collapse: collapse;
        ...
        td:nth-child(2) { width: 15%; } /* Nomor Surat */
        td:nth-child(3) { width: 20%; } /* Pengirim */
        td:nth-child(4) { width: 30%; } /* Perihal */
        td:nth-child(5) { width: 10%; } /* Tanggal Surat */
        td:nth-child(6) { width: 10%; } /* Tanggal Diterima */
        td:nth-child(7) { width: 12%; } /* Status */
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="7" style="text-align: center; color: #777;">Tidak ada data surat masuk yang tersedia.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
