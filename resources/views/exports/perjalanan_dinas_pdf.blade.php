...
<html>
<head>
    <title>Laporan Data Perjalanan Dinas SMAN 2 Banjarmasin</title>
    ...
    <style>
        ...
        /* Styling Tabel Data Perjalanan Dinas */
        table {
            width: 100%;
            border-collapse: collapse;
        ...
        td:nth-child(3) { width: 10%; } /* Jenis Perjalanan */
        td:nth-child(4) { width: 10%; } /* Tgl. Berangkat */
        td:nth-child(5) { width: 10%; } /* Tgl. Kembali */
        td:nth-child(6) { width: 20%; } /* Tujuan */
        td:nth-child(7) { width: 15%; } /* Keterangan */
        td:nth-child(8) { width: 10%; } /* Status */
        td:nth-child(9) { width: 10%; } /* No. Surat Tugas */
        td:nth-child(10) { width: 10%; } /* Tgl. Surat Tugas */
...
<body>
    ...
    <table>
        ...
        <tbody>
            @forelse($perjalananDinas as $index => $pd)
            <tr>
                <td>{{ $index + 1 }}</td>
            ...
            @empty
            <tr>
                <td colspan="10" style="text-align: center; color: #777;">Tidak ada data perjalanan dinas yang tersedia.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
