...
<html>
<head>
    <title>Laporan Data Mutasi Pegawai SMAN 2 Banjarmasin</title>
    ...
    <style>
        ...
        td:nth-child(3) { width: 10%; } /* Jenis Mutasi */
        td:nth-child(4) { width: 30%; } /* Keterangan */
        td:nth-child(5) { width: 15%; } /* SK Mutasi */
        td:nth-child(6) { width: 10%; } /* Nomor Surat */
        td:nth-child(7) { width: 10%; } /* Tanggal Surat */
...
<body>
    ...
    <div class="report-info">
        <div class="report-title">LAPORAN DATA MUTASI PEGAWAI</div> <!-- Judul disesuaikan -->
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="8" style="text-align: center; color: #777;">Tidak ada data mutasi yang tersedia.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
