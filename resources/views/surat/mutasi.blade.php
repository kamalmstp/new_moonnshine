...
<head>
    ...
    <title>Surat Pemberitahuan Mutasi</title>
    <style>
...
<body>
    <div class="letter-container">
        ...
        <div class="content">
            <p style="text-align: right;">Banjarmasin, {{ \Carbon\Carbon::parse($mutasi->tanggal_mutasi)->translatedFormat('d F Y') }}</p>
            <p>Nomor : {{ $mutasi->nomor_surat ?? '-' }}</p>
            <p>Lampiran : -</p>
            <p>Hal : Pemberitahuan Mutasi Pegawai</p>
            ...
            <p class="indent">Berdasarkan Surat Keputusan Nomor: {{ $mutasi->sk_mutasi ?? '-' }} tentang Mutasi Pegawai, dengan ini kami sampaikan bahwa:</p>

            <table>
                <tr>
                    <td>Nama</td>
                    <td>: {{ $mutasi->pegawai->nama_lengkap ?? '-' }}</td>
                </tr>
                <tr>
                    <td>NIP</td>
                    <td>: {{ $mutasi->pegawai->nip ?? '-' }}</td>
                </tr>
                <tr>
                    <td>Jabatan</td>
                    <td>: {{ $mutasi->pegawai->jabatan ?? '-' }}</td>
                </tr>
                <tr>
                    <td>Pangkat/Golongan</td>
                    <td>: {{ $mutasi->pegawai->pangkatGolongan->pangkat_golongan ?? '-' }}</td>
                </tr>
            </table>

            <p class="indent">Telah dimutasikan terhitung mulai tanggal **{{ \Carbon\Carbon::parse($mutasi->tanggal_mutasi)->translatedFormat('d F Y') }}**.</p>
            <p class="indent">Mutasi ini dilakukan dalam rangka {{ $mutasi->keterangan ?? '-' }}.</p>
            <p class="indent">Demikian surat pemberitahuan mutasi ini kami sampaikan untuk menjadi maklum dan dapat ditindaklanjuti sebagaimana mestinya. Atas perhatian Bapak/Ibu, kami mengucapkan terima kasih.</p>
        </div>
